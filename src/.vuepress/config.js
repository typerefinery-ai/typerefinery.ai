...
module.exports = {
  head: [
    ...
    ["meta", { "http-equiv": "Content-Security-Policy", content: "default-src *; script-src 'self' https://static.highlight.io; worker-src 'self' blob:https://static.highlight.io; connect-src https://pub.highlight.run; object-src 'none'; require-trusted-types-for 'script';" }],
