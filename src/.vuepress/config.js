...
module.exports = {
  head: [
    ...
    // ["meta", { "http-equiv": "Content-Security-Policy", content: "default-src *; img-src * 'self' data: https:; script-src 'self' https://static.highlight.io; worker-src 'self' https://static.highlight.io blob:; connect-src https://pub.highlight.run; object-src 'none'; require-trusted-types-for 'script';" }],
