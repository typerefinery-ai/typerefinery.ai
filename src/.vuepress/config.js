...
module.exports = {
  head: [
    ...
    ["meta", { "http-equiv": "Content-Security-Policy", content: `default-src *; img-src * 'self' data: https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' *; style-src 'self' 'unsafe-inline'; worker-src 'self' https://static.highlight.io blob:; connect-src 'self' 'unsafe-eval' https://pub.highlight.run; frame-ancestors *` }],
